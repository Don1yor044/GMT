const En = {
  ...
  ВашеИмя: "Your name",
  "Пожалуйста, введите ваш номер телефона": "Please enter your phone number",
  ВашТелефон: "Your Phone",
  "неправильный адрес электронной почты": "Please enter a valid email address",
  "Пожалуйста, введите свой адрес электронной почты": "Please enter your email",
  ВашEmail: "Your Email",
  ...
  "Помощь в подборе оборудования": "Assistance in selection of equipment",
  ...
  "Специалист по медицинскому оборудованию": "Medical Equipment Specialist",
  ...
  ЗадатьВопрос: "Ask a Question",
  "О товаре": "About the product",
  "О Но синтетическое тестирование, в своём классическом представлении, допускает внедрение поэтапного и последовательного развития общества. В рамках спецификации современных стандартов,сторонники тоталитаризма в науке будут функционально разнесены.":
    "O But synthetic testing, in its classical presentation, allows for the introduction of a step-by-step and consistent development of society. Within the framework of the specification of modern standards, supporters of totalitarianism in science will be functionally separated.",
  ОписаниеОборудования: "Equipment Description",
  ХарактеристикиИдокументы: "Specifications and documents",
  УслугиИсервис: "Services and service",
  ОптовымПокупателям: "For Wholesale Buyers",
  "Биохимический анализатор Mindr UA-66 оснащен открытой платформой для загрузки образцов и отлично размещается на столе в кабинете врача. Функциональная сочетаемость с дополнительным модулем ISE обеспечивает увеличение «скорострельности» прибора от 100 до 300 обработанных пробирок с биоматериалом в час, а также позволит замерять показатели K, Na, Cl и Li в плазме, моче, цереброспинальной жидкости вместе с другими важными параметрами исследования.":
    "The Mindr UA-66 biochemical analyzer features an open platform for loading samples and fits perfectly on a doctor's desk. Functional compatibility with the additional ISE module increases the rate of fire of the device from 100 to 300 processed test tubes with biomaterial per hour, and will also allow you to measure K, Na, Cl and Li in plasma, urine, cerebrospinal fluid along with other important research parameters.",
  "Прибор интуитивно понятен в использовании и техобслуживании, экономен в части финансовых затрат не реагенты. Что важно, калибровка системы аналогична той, что установлена на более современной аппаратуре, и это – идеальный вариант для небольших лабораторий, поскольку емкость погрузчика для проб меньше, чем у мощного оборудования.":
    "The device is intuitive to use and maintain, economical in terms of financial costs not reagents. What is important, the calibration of the system is similar to that installed on more modern equipment, and this is an ideal option for small laboratories, since the sample loader capacity is smaller than that of powerful equipment.",
  "Только небольшая загрузочная емкость для образцов и химических компонентов, если сравнивать с передовой аналогичной техникой, не позволяет этой системе претендовать на принятие в ряды аппаратуры, которой оснащены крупномасштабные лаборатории.":
    "Only the small loading capacity for samples and chemical components, when compared with advanced similar equipment, does not allow this system to claim acceptance into the ranks of equipment with which large-scale laboratories are equipped.",
  ТехническиеХарактеристики: "Technical Specifications",
  ВесОборудования: "Weight of Equipment",
  кг: "kg",
  Детектор: "Detector",
  "CsI - на основе аморфного кремния": "CsI ​​- based on amorphous silicon",
  ВремяСканирования: "Scan Time",
  "PAN стандарт - 12 сек": "PAN standard - 12 sec",
  "Размер фокусного пятна": "Focal spot size",
  ДинамическийДиапазон: "Dynamic Range",
  "16 бит (65 536 градации серого)": "16 bit (65,536 grayscale)",
  РабочееНапряжение: "Working voltage",
  МаксимальныйТок: "Maximum Current",
  Гарантия: "Guarantee",
  "Все услуги": "All services",
  Заголовок: "Headline",
  "Реквизиты для оформеления заказа": "Details for placing an order",
  СначалаПолезные: "Useful First",
  "Сначала новые": "New ones first",
  "Сначала с высокой оценкой": "First with a high rating",
  "Сначала с низкой оценкой": "First with a low rating",
