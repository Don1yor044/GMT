const Uz = {
  ...
  "ФМБА России КЛИНИЧЕСКАЯ БОЛЬНИЦА": "Rossiya FMBA 85-KLINIK shifoxonasi",
 ...
 va AQSh`,
  ...
  лет: "yillar",
  нарынке: "bozorda",
  "оригинальной продукции со всего мира": "butun dunyodan original mahsulotlar",
  ...
  "Задайте их по номеру телефона": "Ulardan telefon raqami orqali so'rang",
  ...
  ЗадатьВопрос: "Savol berish",
  "О товаре": "Mahsulot haqida",
  "О Но синтетическое тестирование, в своём классическом представлении, допускает внедрение поэтапного и последовательного развития общества. В рамках спецификации современных стандартов,сторонники тоталитаризма в науке будут функционально разнесены.":
    "O Lekin sintetik test o'zining klassik taqdimotida jamiyatning bosqichma-bosqich va izchil rivojlanishini joriy etish imkonini beradi. Zamonaviy standartlarning spetsifikatsiyasi doirasida fanda totalitarizm tarafdorlari funktsional jihatdan ajratiladi.",
  ОписаниеОборудования: "Uskuna tavsifi",
  ХарактеристикиИдокументы: "Xarakteristikalar va hujjatlar",
  УслугиИсервис: "Xizmatlar va xizmatlar",
  ОптовымПокупателям: "Ulgurji xaridorlar",
  "Биохимический анализатор Mindr UA-66 оснащен открытой платформой для загрузки образцов и отлично размещается на столе в кабинете врача. Функциональная сочетаемость с дополнительным модулем ISE обеспечивает увеличение «скорострельности» прибора от 100 до 300 обработанных пробирок с биоматериалом в час, а также позволит замерять показатели K, Na, Cl и Li в плазме, моче, цереброспинальной жидкости вместе с другими важными параметрами исследования.":
    "Mindr UA-66 biokimyoviy analizatori namunalarni yuklash uchun ochiq platforma bilan jihozlangan va shifokor kabinetidagi stolga juda mos tushadi. Qo'shimcha ISE moduli bilan funktsional muvofiqligi qurilmaning yong'in tezligini soatiga 100 dan 300 tagacha biomaterial bilan qayta ishlangan naychalarga oshirishni ta'minlaydi, shuningdek plazma, siydikda K, Na, Cl va Li ni o'lchash imkonini beradi, boshqa muhim tadqiqot parametrlari bilan birga miya omurilik suyuqligi.",
  "Прибор интуитивно понятен в использовании и техобслуживании, экономен в части финансовых затрат не реагенты. Что важно, калибровка системы аналогична той, что установлена на более современной аппаратуре, и это – идеальный вариант для небольших лабораторий, поскольку емкость погрузчика для проб меньше, чем у мощного оборудования.":
    "Qurilmadan foydalanish va texnik xizmat ko'rsatish intuitiv, moliyaviy xarajatlar va reagentlar nuqtai nazaridan tejamkor. Muhimi, tizimni kalibrlash zamonaviyroq uskunalarda mavjud bo'lganiga o'xshaydi va kichikroq laboratoriyalar uchun idealdir, chunki namunani yuklash hajmi kattaroq uskunalarga qaraganda kichikroqdir.",
  "Только небольшая загрузочная емкость для образцов и химических компонентов, если сравнивать с передовой аналогичной техникой, не позволяет этой системе претендовать на принятие в ряды аппаратуры, которой оснащены крупномасштабные лаборатории.":
    "Ilg'or shunga o'xshash texnologiya bilan solishtirganda namunalar va kimyoviy komponentlar uchun kichik yuk ko'tarish qobiliyati ushbu tizimni keng ko'lamli laboratoriyalarda jihozlangan asbob-uskunalar qatoriga qabul qilishga imkon bermaydi.",
  ТехническиеХарактеристики: "Texnik spetsifikatsiyalar",
  ВесОборудования: "Uskunaning og'irligi",
  кг: "kg",
  Детектор: "Detektor",
  "CsI - на основе аморфного кремния": "CsI ​​- amorf kremniyga asoslangan",
  ВремяСканирования: "Skanerlash vaqti",
  "PAN стандарт - 12 сек": "PAN standarti - 12 sek",
  "Размер фокусного пятна": "Fokusli nuqta o'lchami",
  ДинамическийДиапазон: "Dinamik diapazon",
  "16 бит (65 536 градации серого)": "16 bit (65 536 kul rang)",
  РабочееНапряжение: "Ishlash kuchlanishi",
  МаксимальныйТок: "Maksimal oqim",
  Гарантия: "Kafolat",
  "Все услуги": "Barcha xizmatlar",
  Заголовок: "Sarlavha",
  "Реквизиты для оформеления заказа": "Buyurtma berish uchun tafsilotlar",
  СначалаПолезные: "Avval foydali",
  "Сначала новые": "Birinchi navbatda yangilari",
  "Сначала с высокой оценкой": "Birinchi bo'lib yuqori baholangan",
  "Сначала с низкой оценкой": "Birinchisi past reyting bilan",
  "12 января 2023": "12 yanvar 2024",
